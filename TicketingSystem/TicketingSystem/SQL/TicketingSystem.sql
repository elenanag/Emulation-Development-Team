...
(
	@UserAccessLevelID INT,
	@AccessLevelName VARCHAR(5)
)
AS
BEGIN
	UPDATE tbUserAccessLevel SET AccessLevelName=@AccessLevelName WHERE UserAccessLevelID=@UserAccessLevelID
END
GO
EXEC spUpdateUserAccessLevel @AccessLevelName = 'admin', @UserAccessLevelID=2
...
AS
BEGIN
	DELETE FROM tbUserAccessLevel WHERE UserAccessLevelID=@UserAccessLevelID
END
GO
EXEC spDeleteUserAccessLevel @UserAccessLevelID = 1
...
BEGIN
	...
	JOIN tbUserAccessLevel u ON c.UserAccessLevelID = u.UserAccessLevelID
